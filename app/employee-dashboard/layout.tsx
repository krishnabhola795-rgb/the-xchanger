...
const navItems = [
  { href: '/employee-dashboard', label: 'Dashboard', shortLabel: 'Home' },
  { href: '/employee-dashboard/search', label: 'Search Cars', shortLabel: 'Cars' },
  { href: '/employee-dashboard/attendance', label: 'Attendance', shortLabel: 'Attend' },
  { href: '/employee-dashboard/customers', label: 'Customers', shortLabel: 'Cust.' },
  { href: '/employee-dashboard/followups', label: 'Follow-ups', shortLabel: 'Follow' },
];
      ...
      <div className="mx-auto flex min-h-screen max-w-7xl flex-col lg:flex-row">
        <aside className="hidden w-72 flex-col border-r border-slate-200 bg-white px-5 py-6 shadow-sm lg:flex">
          <div className="mb-8">
            ...
            <h2 className="mt-2 text-xl font-semibold text-slate-900">Employee Workspace</h2>
            <p className="mt-2 text-sm text-slate-500">Stay on top of customer and vehicle activity.</p>
          </div>
          ...
          <div className="mt-auto rounded-2xl bg-gradient-to-br from-indigo-600 to-blue-500 p-4 text-white">
            ...
            <p className="mt-1 text-sm text-indigo-50">Keep customer follow-ups and attendance tasks moving smoothly.</p>
          </div>
        </aside>
        ...
        <div className="flex-1">
          <header className="border-b border-slate-200 bg-white/90 px-4 py-3 backdrop-blur sm:px-6">
            <div className="flex items-center justify-between gap-3">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.28em] text-slate-500">Employee Portal</p>
